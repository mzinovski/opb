...
class PayedInvestments extends Component
{
	use WithPagination;
    ...
    public function render()
    {
        ...
        $query->where('has_payed', 1)->where('has_signed', 1)->with(['project', 'user']);
        ...
        return view('livewire.clients.payed-investments', ['projects' => $projects, 'investor_users' => $investor_users]);
    }
}
