<div class="row justify-content-center">
	<div class="w-100 pb-5" style="text-align: center!important;">
		<div class="form-check" style="color: white!important;">
		    ...
		    <label class="btn btn-small btn-solid-border btn-round-full text-white" for="option5">Општо</label>
		    ...
		    <label class="btn btn-small btn-solid-border btn-round-full text-white" for="option6">Известувања</label>
		    ...
		    <label class="btn btn-small btn-solid-border btn-round-full text-white" for="option8">Финансиски услуги</label>
		</div>
	</div>
