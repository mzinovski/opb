<div class="row justify-content-center">
	<div class="w-100 pb-5" style="text-align: center!important;">
		<div class="form-check" style="color: black!important;">
			<input type="radio" class="btn-check" wire:model="proektiFilter" name="proektiFilter" value="tekovni_aktivnosti" id="option51" autocomplete="off" checked="">
		    <label class="btn btn-small btn-solid-border btn-round-full" for="option51">Тековни активности</label>
		    
		    <input type="radio" class="btn-check" wire:model="proektiFilter" name="proektiFilter" value="realizirani" id="option61" autocomplete="off">
		    <label class="btn btn-small btn-solid-border btn-round-full" for="option61">Реализирани</label>
