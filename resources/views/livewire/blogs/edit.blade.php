    ...
    <form wire:submit.prevent="submit">
        ...
        <div class="flex flex-row flex-wrap -mx-4 items-stretch">
            ...
            <div class="w-full px-4 py-2" wire:ignore>
                <label class="block text-neutral-800 font-medium text-base mb-1" for="image">Содржина</label>
                <textarea id="body" wire:model='body' name="body" class="min-h-fit h-48">
                </textarea>
            </div>

            <div class="w-full md:w-1/2 px-4 py-2">
                <label class="block text-neutral-800 font-medium text-base mb-1" for="image">Нова слика</label>
            ...
            @if ($image)
            <div class="w-full px-4 py-2">
                <label class="block text-neutral-800 font-medium text-base mb-1" for="image">Приказ</label>
            ...
            @if ($old_image != null)
            <div class="w-full px-4 py-2">
                <label class="block text-neutral-800 font-medium text-base mb-1" for="image">Стара слика</label>
