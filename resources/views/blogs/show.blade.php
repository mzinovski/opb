        ...
        <div class="p-5 lg:p-6">
            ...
            <div class="mx-auto w-[800px] max-w-full relative">
                <div class="block xxl:inline-block relative xxxl:absolute xxl:-left-[65px] xxl:top-5 mb-2 xxl:mb-0">
                    <a href="{{ route('blog.index') }}" class="pl-[18px] relative inline-block font-bold text-[15px] text-mainbrown">
                    ...
                    <div class="flex flex-row flex-wrap -mx-4">
                        <div class="w-full px-4 py-2">
                            ...
                            <div class="flex flex-row shrink items-center justify-between mb-3">
                                ...
                                <div>
                                    <a href="{{ route('blog.edit', $blog) }}" class="inline-block text-center border border-blue-500 rounded-md min-h-[42px] h-auto py-2.5 p-5 text-white bg-blue-500 text-base font-medium leading-tight hover:bg-blue-400 hover:border-blue-400 transition ease-in-out duration-200">Измени блог</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="w-full md:w-1/2 px-4 py-2">
                            <label class="block text-neutral-800 font-medium text-base mb-1" for="slug">Слаг</label>
                        ...
                        <div class="w-full md:w-1/2 px-4 py-2">
                            <label class="block text-neutral-800 font-medium text-base mb-1" for="author">Автор</label>
                        ...
                        <div class="w-full px-4 py-2">
                            <label class="block text-neutral-800 font-medium text-base mb-1" for="image">Текст</label>
                        ...
                        <div class="w-full px-4 py-2">
                            @if ($blog->image != null)
                                <div class="">
                                    ...
                                    <img id="image" src="{{ $blog->image }}" alt="{{ $blog->title }}" class="w-auto max-w-[70%]">
                                </div>
                            @endif
                        </div>
