        ...
        <div class="p-5 lg:p-6">
            ...
            <div class="mx-auto w-[800px] max-w-full relative">
                <div class="block xxl:inline-block relative xxxl:absolute xxl:-left-[65px] xxl:top-5 mb-2 xxl:mb-0">
                    <a href="{{ route('user.index') }}" class="pl-[18px] relative inline-block font-bold text-[15px] text-mainbrown">
                    ...
                    <div class="flex flex-row flex-wrap -mx-4">
                        <div class="w-full px-4 py-2">
                            ...
                            <div class="flex flex-row shrink items-center justify-between mb-3">
                                ...
                                <div>
                                    <a href="{{ route('user.edit', $user) }}" class="inline-block text-center border border-blue-500 rounded-md min-h-[42px] h-auto py-2.5 p-5 text-white bg-blue-500 text-base font-medium leading-tight hover:bg-blue-400 hover:border-blue-400 transition ease-in-out duration-200">Промени корисник</a>
                                </div>
                            </div>

                            <div class="flex flex-row shrink items-start">
                                <div class="w-[140px]">
                                    <label class="block text-neutral-800 font-medium text-base mb-1" for="photo">
                                        Профилна слика
                                    </label>
                        ...
                        <div class="w-full md:w-1/2 px-4 py-2">
                            <label class="block text-neutral-800 font-medium text-base mb-1" for="roles">Улога</label>
