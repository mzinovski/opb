...
@section('title', 'Организација на потрошувалите Битола')
@section('meta_title', 'Организација на потрошувалите Битола')
...
{{-- facebook meta tags --}}
@section('fb_meta_title', 'Организација на потрошувалите Битола')
...
{{--twitter meta tags --}}
@section('twitter_meta_title',  'Организација на потрошувалите Битола')
        ...
        <div class="row">
            <div class="col-lg-9 col-md-10">
                <div class="block">
                    ...
                    <h1 class="animated fadeInUp mb-5">Организација на <br>потрошувачите на <br>Битола</h1>
